...
```text
1. DepartmentChecklistItem.sort_order
2. ChecklistItem.title
```
...
```text
ChecklistItem admin:           list_display/list_filter: title, frequency, is_active
DepartmentChecklistItem admin: item, department, sort_order, is_active
